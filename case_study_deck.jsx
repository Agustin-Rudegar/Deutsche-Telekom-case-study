      ...
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", height: "100%", padding: "0 20px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20 }}>
          {[
            ...
            { num: "04", title: "Human handoff is a design decision, not a failure", desc: "I designed clear boundaries for the AI: it can schedule appointments on its own, but medical advice and payment processing is always for a human. Knowing when NOT to use AI is just as important as knowing when to use it." },
