...
const slides = [
    ...
    <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", height: "100%", padding: "0 20px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20 }}>
        {[
          ...
          { num: "02", title: "Prototyping with real AI reveals what mockups can't", desc: "AI responses are non-deterministic — the same question can produce different answers. Testing with the actual model exposed edge cases in tone, timing, and failure modes that only appear with live output." },
          { num: "03", title: "Transparency builds trust faster than perfection", desc: "When the AI couldn't access a calendar, it said so honestly and offered alternatives. Users responded better to honest limitations than to a system that pretended to be infallible." },
          { num: "04", title: "Human handoff is a design decision, not a failure", desc: "Knowing when NOT to use AI is as important as knowing when to use it. I designed clear boundaries: clinical advice → human, payment processing → human, scheduling → AI." },
  ...
  { id: "connection", render: () => (
    <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", height: "100%", textAlign: "center", padding: "0 60px" }}>
      ...
      <h2 style={{ fontSize: 38, fontWeight: 300, fontFamily: "var(--display)", color: "var(--fg)", margin: "0 0 40px", lineHeight: 1.3 }}>Ready to design AI experiences<br /><span style={{ fontWeight: 600 }}>at scale</span></h2>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20, width: "100%", marginBottom: 40 }}>
        {[
          ...
          { mine: "Vector search with Qdrant + embeddings", dt: "AI-powered product discovery", link: "Semantic understanding for intelligent customer interactions" },
        ].map((row, i) => (
